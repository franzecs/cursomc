...
public class DBService {
	...
	public void instantiateTestDatabase () throws ParseException{
		...
		Cliente cli1 = new Cliente(null, "Maria Silva","fafor.edu@gmail.com", "366655665",TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("989998585","988954125"));
		
		Cliente cli2 = new Cliente(null, "João Pedro","franzecs@gmail.com", "61649864353",TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("989998585","988954125"));
		...
		Endereco e3 = new Endereco(null,"Avenida floriano","2106",null,"Centro","58146985",cli2,c2);
